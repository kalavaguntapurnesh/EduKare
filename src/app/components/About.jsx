  ...
  return (
    <div>
      <div className="w-full h-auto flex flex-wrap flex-col items-center md:mt-36 mt-16">
        ...
        <p className="md:text-lg  text-lg md:text-center text-center md:ml-40 ml-6 md:mr-40 mr-6  mt-8  text-gray-700
       ">
      ...
      <div className="mt-8 flex justify-center items-center ">
       {/*  <img src={mission} className="md:w-1/4 h-[360px]" alt="" />  */}
        ...
        width="200"
        height="200" className='md:w-1/4 w-full h-[360px] md:ml-0 ml-6 md:mr-0 mr-6 ' />
