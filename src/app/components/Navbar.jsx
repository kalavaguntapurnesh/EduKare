  ...
  return (
    <div className="text-black flex justify-between h-24 w-full shadow-xl md:fixed md:top-0 md:z-20 bg-white">
      ...
      <ul className="hidden md:flex  w-1/2 pl-24 pt-4">
        ...
        <li className="p-4 cursor-pointer text-primaryColor font-medium hover:text-black"><Link href="/about">About</Link></li>
        <li className="p-4 cursor-pointer text-primaryColor font-medium hover:text-black"><Link href="/features">Features</Link></li>
        <li className="p-4 cursor-pointer text-primaryColor font-medium hover:text-black"><Link href="/products">Services</Link></li>
        <li className="p-4 cursor-pointer text-primaryColor font-medium hover:text-black"><Link href="/contact">Contact</Link></li>
